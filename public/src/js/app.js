...
function displayConfirmNotification() {
    if('serviceWorker' in navigator) {
        let options = {
            ...
            renotify: true,
            actions: [
                { action: 'confirm', title: 'Ok', icon: '/src/images/icons/crown96x96.png' },
                { action: 'cancel', title: 'Cancel', icon: '/src/images/icons/crown96x96.png' },
            ]
        };
    ...
    navigator.serviceWorker.ready
        ...
        .then( sub => {
            if(sub === null) {
                ...
                let vapidPublicKey = 'BDy8zWY6tczZsikIyzU3Zl2150QNwnreBehIgz_s_5aOh6IbZYqS4pk2-xA86Gp-CuD9oVyK0St3u_wWMMR61Nc';
